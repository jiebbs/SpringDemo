package work.twgj.aopdemo.mybatisPlus;
    ...
    private static FastAutoGenerator create(List<String> tableNames) {
        FastAutoGenerator generator = FastAutoGenerator.create(URL, USERNAME, PASSWORD)
                ...
                .globalConfig(builder -> {
                    ...
                    String outputDir = System.getProperty("user.dir") + "/aop-demo/src/main/java";
                ...
                .packageConfig(builder -> {
                    // 生成的代包公共路径
                    builder.parent("work.twgj.aopdemo");
                    ...
                    builder.entity("entity")
                            ...
                            .pathInfo(Collections.singletonMap(OutputFile.xml,"D://myproject/spring-demo/aop-demo/src/main/resources/mappers"));
