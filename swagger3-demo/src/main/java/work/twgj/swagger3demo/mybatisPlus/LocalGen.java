package work.twgj.swagger3demo.mybatisPlus;
    ...
    private static FastAutoGenerator create(List<String> tableNames) {
        FastAutoGenerator generator = FastAutoGenerator.create(URL, USERNAME, PASSWORD)
                ...
                .globalConfig(builder -> {
                    ...
                    String outputDir = System.getProperty("user.dir") + "/swagger3-demo/src/main/java";
                ...
                .packageConfig(builder -> {
                    // 生成的代包公共路径
                    builder.parent("work.twgj.swagger3demo");
                    ...
                    builder.entity("entity")
                            ...
                            .pathInfo(Collections.singletonMap(OutputFile.xml,"D://myproject/spring-demo/swagger3-demo/src/main/resources/mappers"));
